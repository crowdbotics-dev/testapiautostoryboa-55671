...
## Project Structure
    ...
    ├── testapiautostoryboa_55671  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_55671`
...
2. Clone this repo and `cd testapiautostoryboa_55671`
